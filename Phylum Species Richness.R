...
theme(axis.text.x= element_text(angle=50, vjust= 1, hjust=1.2 ))+
 ylab("Number of Species") +
  add_phylopic(Bryophyta, alpha = 1, x = 5, y = 25, ysize = 35, color = "green4")+
  add_phylopic(Ascomycota, alpha = 1, x = 3, y = 25, ysize = 30, color = "orange")+
add_phylopic(Basidomycota, alpha = 1, x = 4, y = 25, ysize = 35, color = "red")+
  add_phylopic(Tracheophyta, alpha = 1, x = 8, y = 165, ysize = 35, color = "green")+
  add_phylopic(Arthropods, alpha = 1, x = 2, y = 140, ysize = 25, color = "yellow")+
  add_phylopic(Chordata, alpha = 1, x = 6, y = 105, ysize = 10, color = "red")+
  add_phylopic(Annelida, alpha = 1, x = 1, y = 25, ysize = 30, color = "pink")+
  add_phylopic(Mollusca, alpha = 1, x = 7, y = 25, ysize = 25, color = "blue")+ 
  ylim(0,180) +
